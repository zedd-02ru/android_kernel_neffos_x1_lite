...
#if defined CONFIG_TPLINK_PRODUCT_TP904 && !defined CONFIG_TPLINK_PRODUCT_TP912 && !defined CONFIG_TPLINK_PRODUCT_TP910
			printk("%s: enable switch.......\n",__func__);
			AudDrv_GPIO_EXTAMP2_Select(true,1);
#endif
		}
...
#if defined CONFIG_TPLINK_PRODUCT_TP904 && !defined CONFIG_TPLINK_PRODUCT_TP912 && !defined CONFIG_TPLINK_PRODUCT_TP910
            printk("%s: disable switch.......\n",__func__);
            AudDrv_GPIO_EXTAMP2_Select(false,1);
#endif
...
#if defined CONFIG_TPLINK_PRODUCT_TP904 && !defined CONFIG_TPLINK_PRODUCT_TP912 && !defined CONFIG_TPLINK_PRODUCT_TP910
        // [wuhefeng] turn on analog switch after turning off headphone
        AudDrv_GPIO_EXTAMP2_Select(true, 1);
#endif
	}
}
...
#if defined CONFIG_TPLINK_PRODUCT_TP904 && !defined CONFIG_TPLINK_PRODUCT_TP912 && !defined CONFIG_TPLINK_PRODUCT_TP910
/* [wuhefeng] turn off earphone in LOUDSPK mode */
static int Audio_Earphone_Switch_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
    mutex_lock(&Ana_Ctrl_Mutex);
...
#else
		AudDrv_GPIO_EXTAMP_Select(true, 5);
#endif /*CONFIG_MTK_LEGACY*/
...
#if defined CONFIG_TPLINK_PRODUCT_TP904 && !defined CONFIG_TPLINK_PRODUCT_TP912 && !defined CONFIG_TPLINK_PRODUCT_TP910
        // [wuhefeng] turn on analog switch when turn off speaker
        AudDrv_GPIO_EXTAMP2_Select(true, 1);
#endif
	}
	return 0;
...
#if defined CONFIG_TPLINK_PRODUCT_TP904 && !defined CONFIG_TPLINK_PRODUCT_TP912 && !defined CONFIG_TPLINK_PRODUCT_TP910
	SOC_ENUM_EXT("Audio_Earphone_Mute_Switch", Audio_DL_Enum[13], Audio_AmpR_Get,
		     Audio_Earphone_Switch_Set),
#endif
		...
		if (ADCType == AUDIO_ANALOG_DEVICE_IN_ADC1) {	/* main and headset mic */
			...
			if (mCodec_data->mAudio_Ana_Mux[AUDIO_MICSOURCE_MUX_IN_1] == 0) {	/* "ADC1", main_mic */
				...
				if (ECMmode == 1) {	/* differential */
					...
					//Enable MICBIAS0 and MICBIAS1, MISBIAS0 = 1P9V, [6752] ALPS01824949 */
					Ana_Set_Reg(MT6353_AUDENC_ANA_CON9, 0x0712, 0xff1f); /* [wuhefeng] enable MICBIAS1 only */
					...
					//Enable MICBIAS0 and MICBIAS1, MISBIAS0 = 1P9V , [6752] ALPS01824949 */
					Ana_Set_Reg(MT6353_AUDENC_ANA_CON9, 0x0701, 0xff1f); /* [wuhefeng] enable MICBIAS0 only */
					/* Enable MICBIAS0 and MICBIAS1, MISBIAS0 = 2P5V */
				}
...
#if defined CONFIG_TPLINK_PRODUCT_TP904 && !defined CONFIG_TPLINK_PRODUCT_TP912 && !defined CONFIG_TPLINK_PRODUCT_TP910
    // [wuhefeng] turn on analog switch when boot
    AudDrv_GPIO_EXTAMP2_Select(true,1);
#endif
	return 0;
}
