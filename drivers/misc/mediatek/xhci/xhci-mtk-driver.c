...
static void mtk_enable_otg_mode(void)
{
	...
	bq2560x_set_otg_config(0x01);         // [zhangdong] Config tp910 otg func
#else
	set_chr_enable_otg(0x1);
	set_chr_boost_current_limit(1500);
#if defined(CONFIG_RT9460_SUPPORT)
	battery_charging_control(CHARGING_CMD_SET_CV_VOLTAGE, 4080000);  // [zhangdong] Config tp912 otg func
#endif
#endif
...
static void mtk_disable_otg_mode(void)
{
	...
	bq25898_otg_en(0x0);
#elif defined(CONFIG_MTK_BQ2560X_SUPPORT)
	bq2560x_set_otg_config(0x00);         // [zhangdong] Config tp910 otg func
#else
	set_chr_enable_otg(0x0);
#if defined(CONFIG_RT9460_SUPPORT)
	battery_charging_control(CHARGING_CMD_SET_CV_VOLTAGE, 4400000);  // [zhangdong] Config tp912 otg func
#endif
#endif
#if defined(CONFIG_MTK_BQ24296_SUPPORT)
