...
#define IMX258_OFILM_MID  0x05
#define MODULE_SUNWIN_MID 0x01
#define MODULE_TRULY_MID  0x02
#define OV13855_SUNWIN_MID  0x01// [linyimin] support sunwin ov13855

/* [huangxiancong start] distinguish the camera module */
typedef enum {
	MODULE_DEFAULT_NULL = 0,
	MODULE_OV5675_SUNWIN,
	MODULE_OV5675_OFILM,
	MODULE_IMX258_OFILM,
	MODULE_IMX258_TRULY,
	MODULE_OV13855_SUNWIN,// [linyimin] add ov13855
