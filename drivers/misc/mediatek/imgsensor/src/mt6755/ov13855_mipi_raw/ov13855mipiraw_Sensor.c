...
extern int read_imx13855_eeprom_MID(void);

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static kal_uint8 OV13855MIPI_AWB_Data[20];/* [linyimin end] Add awb cali */
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                /* [linyimin start] Read 13855 mid */
                mid = read_imx13855_eeprom_MID();
...
extern bool read_ov13855_eeprom_AWB(kal_uint16 addr, BYTE* data, kal_uint32 size);
#define GAIN_DEFAULT 0x0100
#define GOLDEN_RG_VALUE 0x147 // dev #13
#define GOLDEN_BG_VALUE 0x18d // dev #13
void apply_awb_otp(void)
{
	int rg=0;
	int bg=0;
	...
	if (!read_ov13855_eeprom_AWB(0x0020,OV13855MIPI_AWB_Data,12))
	{
	...
	rg = (OV13855MIPI_AWB_Data[0] << 8) + OV13855MIPI_AWB_Data[1];
	bg = (OV13855MIPI_AWB_Data[2] << 8) + OV13855MIPI_AWB_Data[3];
