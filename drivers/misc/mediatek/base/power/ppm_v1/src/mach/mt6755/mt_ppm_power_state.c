	...
	struct ppm_hica_algo_data data, struct ppm_state_transfer *settings)
{
	...
	unsigned int ppb_idx;      // [zhangdong] Modify cpu strategy
	...
	// [zhangdong start]
	/*
	 * Modify the trans rule from LL_ONLY to L_ONLY
	 *
	 * remove check freq in powersave mode
	 */
