...
/* [lichenggang start] add TP912 LCM */
#if defined(S61350_720P_DSI_VDO_FP7720_TRULY)
	&s61350_720p_dsi_vdo_fp7720_truly_lcm_drv,
#endif

#if defined(HX8394F_720P_DSI_VDO_FP7720_BOOYI)
	&hx8394f_720p_dsi_vdo_fp7720_booyi_lcm_drv,
#endif
/* [lichenggang end] */
...
/* [jiangtingyu start] add TP902 LCM */
#if defined(FT8607_720P_DSI_VDO_TPS65132_TIANMA)
	&ft8607_720p_dsi_vdo_tps65132_tianma_lcm_drv,
#endif

#if defined(FT8716_FHD_DSI_VDO_TPS65132)
	&ft8716_fhd_dsi_vdo_tps65132_lcm_drv,
#endif

#if defined(ILI9881C_720P_DSI_VDO_TPS65132_DJN)
	&ili9881c_720p_dsi_vdo_tps65132_djn_lcm_drv,
#endif
/* [jiangtingyu end] */
