...
#define STK_ALS_FIR
// #define STK_IRS
/* [yanlin start] Open for esd check */
#define STK_CHK_REG
/* [yanlin end] */
// #define STK_GES
 ...
 * extern functions
*******************************************************************************/
/* [yanlin start] reg settings */
#ifdef CONFIG_TPLINK_PRODUCT_TP910
#define ALSCTRL_REG_VALUE 0x3A
#else
#define ALSCTRL_REG_VALUE 0x39
#endif
/* [yanlin end] */
...
/* [yanlin start] modified calibration */
	...
	#define STK_LT_N_CT	25
	#define STK_HT_N_CT	45
	#define PS_THDH_LIMITED 1100
	#define PS_THDL_LIMITED 1000
	#define PS_MAX_THD_RANGE 950
#else
	#define STK_MAX_MIN_DIFF	200
	...
	{
		{
			...
			.len = 1,
			.buf= &beg,
/* [yanlin start] I2C timing control */
...
//	obj->hw = get_cust_alsps_hw();
	...
	atomic_set(&obj->alsctrl_val, ALSCTRL_REG_VALUE); // [yanlin] reg settings
