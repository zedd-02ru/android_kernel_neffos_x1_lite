...
stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{OV13856_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid},
	...
	{IMX258XL_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid},
...
unsigned int cam_cal_check_mtk_cid(struct i2c_client *client, cam_cal_cmd_func readCamCalData)
{
	...
	if (readCamCalData != NULL) {
		readCamCalData(client, 0, (unsigned char *)&calibrationID, 1);
