...
#define CALL_ACTIVE_ICHR CHARGE_CURRENT_600_00_MA
/* [lifeiping end] */
...
typedef enum {
	TEMP_SPEC_BELOW_POS_47 = 0,
	TEMP_SPEC_POS_47_TO_POS_49,
	TEMP_SPEC_ABOVE_POS_49
} temp__spec_state_enum;

#define TEMP_SPEC_POS_49_THRESHOLD  44
#define TEMP_SPEC_POS_49_THRES_MINUS_X_DEGREE 42

#define TEMP_SPEC_POS_47_THRESHOLD  42
#define TEMP_SPEC_POS_47_THRES_MINUS_X_DEGREE 40

#define TEMP_SPEC_POS_45_THRESHOLD  42
/* [lidebiao end] */
...
#endif
/*[lidebiao start]*/
extern kal_bool is_disable_charging_mode;
/*[lidebiao end]*/
/*[lidebiao start] for compatible with 5V2A TA*/
extern kal_bool is_5v2a_ta_connect;
extern unsigned int charge_current_check_count;
extern struct mutex ta_5v2a_connect_mutex;
/*[lidebiao end]*/
extern kal_bool is_fastcharging_test;	// [lidebiao] add for fastcharging test
extern kal_bool is_in_runin_test_mode;	// [lidebiao] control battery level for runin test
extern unsigned char g_exhibition_mode; // [wuzhe] add for exhibition mode support
extern unsigned int g_total_charger_on_time; // [wuzhe] add for exhibition mode support
/*****************************************************************************
 *  Extern Function
 ****************************************************************************/
...
extern kal_bool is_set_transport_mode(void);
...
extern int battery_pump_express20_algorithm_set_vbus(CHR_VOLTAGE_ENUM chr_vol);
#endif
...
extern unsigned int bq25890_get_ichg(void);
extern unsigned int bq25890_get_vbus(void);
#endif

/* [lifeiping start] */
extern unsigned int get_Screen_State(void);
extern unsigned int get_Call_State(void);
/* [lifeiping end] */

extern void mt_bc12_dcd_release(void) __attribute__((weak));

/* [lifeiping] for reliability test */
extern kal_bool get_Temp_Charging_Protect_Mode(void);
