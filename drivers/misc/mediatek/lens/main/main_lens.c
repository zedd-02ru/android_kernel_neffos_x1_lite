...
static stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_DW9714AF, DW9714AF_SetI2Cclient, DW9714AF_Ioctl, DW9714AF_Release},
        ...
        #endif
        #ifdef CONFIG_MTK_LENS_DW9800AF_SUPPORT
        {1, AFDRV_DW9800XLAF, DW9800XLAF_SetI2Cclient, DW9800XLAF_Ioctl, DW9800XLAF_Release},
        #endif
        #ifdef CONFIG_MTK_LENS_DW9800AF_SUPPORT
        {1, AFDRV_DW9800SWAF, DW9800SWAF_SetI2Cclient, DW9800SWAF_Ioctl, DW9800SWAF_Release},
        #endif
