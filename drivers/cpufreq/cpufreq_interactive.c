...
// [zhangdong start] Add head file
#include <linux/leds.h>
#include <../misc/mediatek/leds/mt6755/leds_hal.h>
// [zhangdong end]
...
static int bl_brightness;       // [zhangdong] backlight brightness

#define SUSPEND_FREQ_INDEX 4    // [zhangdong] hispeed_freq index of LCM off
...
#define DEFAULT_GO_HISPEED_LOAD 99
	 ...
	 * down.
	 */
#define DEFAULT_MIN_SAMPLE_TIME (20 * USEC_PER_MSEC)        // [zhangdong] Modify 80 to 20
...
static void cpufreq_interactive_timer(unsigned long data)
{
...
#endif
	int ppb_idx;
	int min_sample_t[4] = {80, 20, 20, 80}; // [zhangdong] Revert modify {80,20,20,80} to {20,20,20,20}
#endif
	...
	bl_brightness = mt_get_bl_brightness();      // [zhangdong] Get the backlight brightness
	...
	// [zhangdong start]
	/*
	 * Modify the parameters according on/off
	 *
	 * If LCM on, remain unchanged
	 *
	 * If LCM off, set hispeed_freq MAX freq of LCM off
	 */
	...
	if (ppb_idx == 0 && (arch_get_cluster_id(pcpu->policy->cpu) >= 1)) {
		...
		if (bl_brightness != 0) {
			...
			tunables->hispeed_freq = pcpu->freq_table[SUSPEND_FREQ_INDEX].frequency;
			tunables->min_sample_time = DEFAULT_MIN_SAMPLE_TIME;
		}
	}
#endif
