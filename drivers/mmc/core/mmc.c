...
/* [jiangtingyu start] Add hwinfo node at /sys/kernel/emmc_info */
...
struct emmc_hw_info {
	...
	char *type;
	char *vendor;
	/* [fengyunliang start] add memory and storage info */
        char *memory;
        char *storage;
	/* [fengyunliang end] */
};
...
static struct emmc_hw_info emmc_hw_info_list[] = {
	/* [fengyunliang start] add memory and storage info */
	{"Q823MB", "KMQ820013M_B419", "Samsung", "2G", "16G"},
	{"RX1BMB", "KMRX1000BM_B614", "Samsung", "3G", "32G"},
	{"DF4016", "SDADF4AP_16G", "Sandisk", "2G", "16G"},
	{"HAG4a2", "H9TQ17ABJTBCUR_KUM", "Hynix", "2G", "16G"},
	{"RC14MB", "KMRC10014M_B809", "Samsung", "4G", "64G"},
	{"QE13MB", "KMQE10013M_B318", "Samsung", "2G", "16G"},
	{"QE63MB", "KMQE60013M_B318", "Samsung", "2G", "16G"},
	{"DL2032", "SDADL2BP_32G", "Sandisk", "3G", "32G"},
	/* [fengyunliang start] Add hw_info support KMRH60014A_B614 */
	{"RH64AB", "KMRH60014A_B614", "Samsung", "4G", "64G"},
	/* [fengyunliang end] */
	/* [zhaoyue start] Add hw_info support KMGX6001BM_B514 */
	{"GX6BMB", "KMGX6001BM_B514", "Samsung", "3G", "32G"},
	/* [zhaoyue end] */
