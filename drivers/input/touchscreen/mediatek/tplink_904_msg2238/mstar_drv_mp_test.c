...
// Modify.
// Modify.
#include "open_test_RIU1_DJN.h"    ///////////////////////////mptest.c       l59c  djn  l59c  djn
#include "open_test_RIU2_DJN.h"
#include "open_test_RIU3_DJN.h"

// Modify.
#include "short_test_RIU1_DJN.h"
#include "short_test_RIU2_DJN.h"
#include "short_test_RIU3_DJN.h"
#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE  
#include "short_test_RIU4_DJN.h"
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE  ////////////////mptest.c       l59c  djn  l59c  djn
...
#define TP_TYPE_DJN    (2)
#define TP_TYPE_DJN_TP905 (3)
...
//        RegSet16BitValue(0x160C, RegGet16BitValue(0x160C) & (~0x01));      
    ...
    DBG(&g_I2cClient->dev, "*** n_major = %d ****** n_minor = %d ***\n", nMajor,nMinor);
...
static u16 _DrvMpTestItoTestSelfICChooseTpType(void)
{
    ...
    for (i = 0; i < 10; i ++)
    {
        ...
        if ((TP_TYPE_DJN == nTpType)|| (TP_TYPE_DJN_TP905==nTpType))// || TP_TYPE_Y == nTpType) // Modify.
        {
            break;
        }
        else if (i < 5)
    ...
    if ((TP_TYPE_DJN == nTpType)||(TP_TYPE_DJN_TP905 == nTpType)) // Modify.
    {
#ifdef CONFIG_ENABLE_CHIP_TYPE_MSG21XXA
        if (g_ChipType == CHIP_TYPE_MSG21XXA)   
        {
        ...
        if (g_ChipType == CHIP_TYPE_MSG22XX)   
        {
            _gMsg22xxOpenRIU1 = open_1_DJN;
            _gMsg22xxOpenRIU2 = open_2_DJN;
            _gMsg22xxOpenRIU3 = open_3_DJN;

            _gMsg22xxShort_RIU1 = short_1_DJN;
            _gMsg22xxShort_RIU2 = short_2_DJN;
            _gMsg22xxShort_RIU3 = short_3_DJN;

            _gMsg22xxOpenSubFrameNum1 = NUM_OPEN_1_SENSOR_DJN;
            _gMsg22xxOpenSubFrameNum2 = NUM_OPEN_2_SENSOR_DJN;
            _gMsg22xxOpenSubFrameNum3 = NUM_OPEN_3_SENSOR_DJN;
            _gMsg22xxShortSubFrameNum1 = NUM_SHORT_1_SENSOR_DJN;
            _gMsg22xxShortSubFrameNum2 = NUM_SHORT_2_SENSOR_DJN;
            _gMsg22xxShortSubFrameNum3 = NUM_SHORT_3_SENSOR_DJN;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
            _gMsg22xxShort_RIU4 = short_4_DJN;
            _gMsg22xxShortSubFrameNum4 = NUM_SHORT_4_SENSOR_DJN;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE

            _gSelfIC_MAP1 = MAP1_DJN;
            _gSelfIC_MAP2 = MAP2_DJN;
            _gSelfIC_MAP3 = MAP3_DJN;
            _gSelfIC_MAP40_1 = MAP40_1_DJN;
            _gSelfIC_MAP40_2 = MAP40_2_DJN;
            _gSelfIC_MAP41_1 = MAP41_1_DJN;
            _gSelfIC_MAP41_2 = MAP41_2_DJN;

            _gSelfIC_SHORT_MAP1 = SHORT_MAP1_DJN;
            _gSelfIC_SHORT_MAP2 = SHORT_MAP2_DJN;
            _gSelfIC_SHORT_MAP3 = SHORT_MAP3_DJN;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE       
            _gSelfIC_MAP40_3 = MAP40_3_DJN;
            _gSelfIC_MAP40_4 = MAP40_4_DJN;
            _gSelfIC_MAP41_3 = MAP41_3_DJN;
            _gSelfIC_MAP41_4 = MAP41_4_DJN;

            _gSelfIC_SHORT_MAP4 = SHORT_MAP4_DJN;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
 
            _gSelfICItoTestKeyNum = NUM_KEY_DJN;
            _gSelfICItoTestDummyNum = NUM_DUMMY_DJN;
            _gSelfICItoTestTriangleNum = NUM_SENSOR_DJN;
            _gSelfICIsEnable2R = ENABLE_2R_DJN;
        }
#endif //CONFIG_ENABLE_CHIP_TYPE_MSG22XX
    }
	#if 0
...
static ItoTestResult_e _DrvMpTestSelfICItoShortTestEntry(void)
{
    ...
    TPD_ERR("***_DrvMpTestSelfICItoShortTestEntry***\n");
...
static s32 _DrvMpTestItoOpenTest(void)
{
    ...
    DBG(&g_I2cClient->dev, "*** %s() ***g_ChipType=0x%x\n", __func__,g_ChipType);
...
static s32 _DrvMpTestItoShortTest(void)
{
    ...
    TPD_ERR("***_DrvMpTestItoShortTest***\n");
...
static void _DrvMpTestItoTestDoWork(struct work_struct *pWork)
{
    ...
    TPD_ERR("*** %s::g_IsInMpTest = %d, _gTestRetryCount = %d ***\n", __func__, g_IsInMpTest, _gTestRetryCount);
    ...
    {
        TPD_ERR("*** tp905::Undefined Mp Test Mode = %d ***\n", _gItoTestMode);
        return;
    }

    TPD_ERR("*** ctp mp test result = %d ***\n", nRetVal);
    
    if (nRetVal == ITO_TEST_OK) //nRetVal == 0
    {
        _gCtpMpTestStatus = ITO_TEST_OK; //PASS
        g_IsInMpTest = 0;
        TPD_ERR("tp905::mp test success\n");
    }
    else
    {
        _gTestRetryCount --;
