...
#define PROC_NODE_HW_INFO                     "hw_info"
...
/*--------------------------------------------------------------------------*/
//extern ssize_t DrvMainProcfsHwInfoRead(struct file *pFile, char __user *pBuffer, size_t nCount, loff_t *pPos);
extern ssize_t DrvMainProcfsHwInfoRead(struct device *dev, struct device_attribute *attr, char *buf);
