...
* Return: char count
***********************************************************************/
//extern struct fts_i2c_client;
//static ssize_t firmware_update_write_func(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
//static u8 FIRMWARE_VERSION_FROM_BINFILE;
/* [lichenggang start]modify for firmware update by node*/
...
ssize_t firmware_update_read_func(struct file *file, char __user *user_buf, size_t count, loff_t *ppos)
{
    ...
    u8 firmware_version;
    char page[512];
    fts_read_reg(fts_i2c_client, 0xA6, &firmware_version);
