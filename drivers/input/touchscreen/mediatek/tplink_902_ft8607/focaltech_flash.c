...
/* [lichenggang start]app.bin file path*/
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
    ...
    do
    {
        ...
        if ((uc_tp_vendor_id == FTS_VENDOR_ID_TIANMA))
        {
#ifdef  BOOT_UPGRADE_AUTO
            ...
            if (((uc_tp_fm_ver < uc_host_fm_ver) && uc_host_fm_ver != 0) || (uc_tp_fm_ver > 0x2F)) // force upgrade
            {
                bUpgradeFlag = true;
            }
            /* [lichenggang end] */
