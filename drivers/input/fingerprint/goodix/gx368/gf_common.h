...
#define GF_NAV_INPUT_UP			  KEY_FP_UP           //KEY_UP
#define GF_NAV_INPUT_DOWN		  KEY_FP_DOWN         //KEY_DOWN
#define GF_NAV_INPUT_LEFT		  KEY_FP_LEFT         //KEY_LEFT
#define GF_NAV_INPUT_RIGHT		  KEY_FP_RIGHT        //KEY_RIGHT
#define GF_NAV_INPUT_CLICK		  KEY_FP_CLICK        //KEY_VOLUMEDOWN
#define GF_NAV_INPUT_DOUBLE_CLICK KEY_FP_DOUBLE_CLICK //KEY_VOLUMEUP
#define GF_NAV_INPUT_LONG_PRESS   KEY_FP_LONG_CLICK   //KEY_SEARCH
#define GF_NAV_INPUT_HEAVY		KEY_CHAT

#define GF_KEY_INPUT_HOME		KEY_FP_CLICK //KEY_HOMEPAGE
...
/* [taoyancheng] Add oem gpio config */
    struct pinctrl_state *pins_irq_pull_down;
