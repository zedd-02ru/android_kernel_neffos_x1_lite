...
/*----------------------------------------------------------------------------------------------*/
/* [liguanxiong start] */
#define SUNWAVE_LIB_VERSION    "20171114_N.12.5"
...
#endif
/* [liguanxiong end]*/
/* [liguanxiong start] Declare external global variable value */
#if defined(CONFIG_GOODIX_FINGERPRINT_GX368)
extern int is_gx368_read_id_ok;
#endif
/* [liguanxiong start] */
...
/* [liguanxiong start] skip probe sw9251 if gx368 has been existed */
#if defined(CONFIG_GOODIX_FINGERPRINT_GX368)
    if (1 == is_gx368_read_id_ok) {
        sw_err("gx368 has been existed!\n");
        return -ENODEV;
    }
#endif
/* [liguanxiong end] */
